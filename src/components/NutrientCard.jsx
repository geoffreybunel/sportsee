function NutrientCard({icon, name, color, value}) {
    return (
        <div className="bg-[#FBFBFB] h-31 flex items-center gap-3.5 p-5 h-auto">
            ...
            <div className="flex flex-col">
                <span className="text-xl font-bold text-[#282D30]">{value}</span>
